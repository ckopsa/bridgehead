...
### Four recipes worth arming in your first batch
...
**4. Hold the pass** — the territorial rule, and the one that most repays a
...
A caution that applies to all four: `then` is frozen when you arm it, so ids in
